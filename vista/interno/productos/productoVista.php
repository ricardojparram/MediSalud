      ...
      <div class="modal fade" id="basicModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
                <div class="modal-dialog modal-xl">
                      ...
                      <div class="container-fluid">
                        <div class="row">
                          ...
                          <div class="form-group col-lg-8">
                              ...
                              <input name="descripcion" id="descripcion" class="form-control" placeholder="descripcion del producto">
                              </div>
                            </div>
                           ...
                           <div class="form-group col-lg-4">
                             ...
                             <button type="button" class="iconos btn btn-secondary" data-bs-trigger="hover focus"data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content=" Descripción "><i class="bi bi-calendar"></i></button> 
                               <input type="date" name="fechaV" id="fecha" class="form-control">
                             </div>
                            </div>
                      ...
                      <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                              ...
                              <input class="form-control" name="composicionP" id="composición" placeholder="Composición del producto">
                             </div>
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                              ...
                              <input class="form-control" name="posologia" id="posologia" placeholder="posologia">
                             </div> 
                            </div>
                      ...
                      <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-3">
                              ...
                              <select class="form-control" aria-label="Default select example" name="laboratorio" id="laboratorio">
                            ...
                            <div class="form-group col-lg-3">
                              ...
                              <select class="form-control" aria-label="Default select example" name="tipoP" id="tipoP">
                                <option selected disabled>Seleccione una opción</option>
                          ...
                          <div class="form-group col-lg-3">
                              ...
                              <select class="form-control" aria-label="Default select example" name="presentación" id="presentación">
                               <option selected disabled>Seleccione una opción</option>
                                  <?php if(isset($mostraPres)){
                                   foreach($mostraPres as $data){
                                   ?> 
                                  <option value="<?php echo $data->cod_pres; ?>" class="opcion"><?php echo $data->cantidad; ?>X<?php echo $data->medida; ?>mg</option>
                                  <?php
                                    }
                                  }else{"";}?>
                          ...
                          <div class="form-group col-lg-3">
                              ...
                              <select class="form-control" aria-label="Default select example" name="ubicación" id="ubicación">
                      ...
                      <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4">
                              ...
                              <input class="form-control" name="contraIn" id="contraIn" placeholder="text">
                            </div>
                          </div>
                           ...
                           <div class="form-group col-lg-4">
                             <label class="col-form-label"> <strong> Precio de venta*</strong></label>
                              ...
                              <input  class="form-control" name="precioV" id="precioV" placeholder="Precio de venta">
                             </div>
                            </div>
                  ...
                  <div class="modal-footer">
                    <button id="cerrar" type="reset" class="btn btn-secondary cerrar" data-bs-dismiss="modal">Cancelar</button>
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-lg-3">
                            ...
                            <div class="form-group col-lg-3">
                              ...
                              <div class="input-group">
                               <button type="button" class="iconos btn btn-secondary" data-bs-trigger="hover focus"data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="  Descripción "><i class=" ri-map-2-line"></i></button>
                              <select class="form-control" aria-label="Default select example" name="ubicaciónEd" id="ubicaciónEd">
                                <option value="" selected="" >Seleccione una opción</option>
                                  <option value="Pasillo 1">Pasillo 1</option>
                                  <option value="Pasillo 2">Pasillo 2</option>
                                  <option value="Pasillo 3">Pasillo 3</option>
